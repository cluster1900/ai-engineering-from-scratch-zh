...
(function () {
  ...
  function paint(n) {
    ...
    for (var j = 0; j < links.length; j++) {
      links[j].setAttribute('aria-label', '在 GitHub 上查看 ai-engineering-from-scratch，' + format(n) + ' 个 star');
    }
  }
  ...
  /**
   * 朗读是站点能力，而不是页面模板的职责。从共享 header
   * 中加载一次，确保新页面不会在无提示的情况下遗漏它。
   */
