// 采用参考手册美学的共享语言选择器：一个等宽字体蓝图风格
// 按钮，点击后会打开可筛选的面板，其中显示各语言的本地名称。从
// window.AIFS_LANGS（site/langs.js）读取注册表。在课程页面上，宿主
// 会设置 window.AIFS_onLangChange，以使用所选语言重新渲染；在
// 首页上，选择语言只会存储偏好，以供稍后使用。
(function () {
  'use strict';
  ...
  function mount(host) {
    ...
    panel.innerHTML = '<div class="lang-panel-head" id="' + id + 'Title">语言</div>'
      ...
      + '<div class="lang-list" id="' + id + 'List" role="listbox" aria-label="语言"></div>';
